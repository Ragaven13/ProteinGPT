...
RESULTS_DIR = "results"
OUTPUT_CSV = "results/generated_lstm_500.csv"
...
def main():
    ...
    print(f"Generating {NUM_SEQUENCES} LSTM protein sequences...")
    ...
    print(f"\nSaved {len(df)} LSTM sequences to:")
    print(OUTPUT_CSV)
